...
### Viewing
Images (JPEG, PNG, GIF, WebP, TIFF, BMP, ICO, SVG) and videos (MP4, AVI, MOV, MKV, WebM) with zoom, pan, fullscreen, frame-by-frame navigation, and playback speed control (0.1x–8x).
