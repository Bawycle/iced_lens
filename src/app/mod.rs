...
use crate::diagnostics::{
    DiagnosticsCollector, ErrorType, UserAction, WarningType,
};
use crate::media::metadata::MediaMetadata;
use crate::media::{self, MaxSkipAttempts, MediaNavigator};
#[cfg(test)]
use crate::media::MediaData;
use crate::ui::diagnostics_screen;
use crate::ui::help;
use crate::ui::image_editor::State as ImageEditorState;
#[cfg(test)]
...
impl App {
    ...
    // Handler methods are in handlers.rs
