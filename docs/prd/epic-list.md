...
| **Epic 4** | Diagnostics Collection Completeness | Achieve 100% diagnostic event coverage with proper architectural placement, fixing UI-layer violations and instrumenting all missing user actions, state events, and operations |
