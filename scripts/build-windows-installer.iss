...
; ICO is generated by build.rs from assets/branding/iced_lens.svg
SetupIconFile=..\target\branding\iced_lens.ico
...
; Icon files (for shell integration) - generated by build.rs from SVG source
Source: "..\target\branding\iced_lens.ico"; DestDir: "{app}"; Flags: ignoreversion
