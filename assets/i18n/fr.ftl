...
# Filter dropdown
filter-dropdown-tooltip = Filtrer les médias
filter-dropdown-tooltip-active = Actifs : { $filters }
filter-panel-title = Filtre
filter-reset-button = Réinitialiser
filter-media-type-label = Type de média
filter-media-type-all = Tous
filter-media-type-images = Images uniquement
filter-media-type-videos = Vidéos uniquement
filter-media-type-placeholder = Sélectionner...
filter-date-label = Filtre par date
filter-date-field-label = Filtrer par
filter-date-field-modified = Date de modification
filter-date-field-created = Date de création
filter-date-start-label = Du
filter-date-end-label = Au
filter-date-day-placeholder = JJ
filter-date-month-placeholder = MM
filter-date-year-placeholder = AAAA
filter-date-clear = Effacer la date
filter-tooltip-date-from = à partir du { $date }
filter-tooltip-date-to = jusqu'au { $date }
...
settings-persist-filters-label = Mémoriser les filtres
settings-persist-filters-hint = Conserver les paramètres de filtrage entre les sessions.
settings-persist-filters-disabled = Non
settings-persist-filters-enabled = Oui
...
error-video-decoder-died = Le décodeur vidéo s'est arrêté de façon inattendue. Essayez de recharger la vidéo.
error-video-seek-timeout = La recherche de position a expiré. La position cible est peut-être au-delà de la fin de la vidéo.
...
help-viewer-tool-filter = Filtre
help-viewer-tool-filter-desc = Afficher uniquement les fichiers correspondants. Filtrer par type, orientation ou plage de dates.
...
metadata-section-processing = Traitement
metadata-label-software = Logiciel
metadata-label-date-modified = Modifié
...
image-editor-metadata-options-title = Métadonnées
image-editor-metadata-add-software = Ajouter le tag logiciel et la date de modification
image-editor-metadata-strip-gps = Supprimer les données GPS
...
diagnostics-events-running-for = Événements : { $duration }
diagnostics-resources-running-for = Ressources : { $duration }
...
notification-diagnostics-clipboard-success = Diagnostics copiés dans le presse-papiers
notification-diagnostics-clipboard-error = Échec de la copie des diagnostics
