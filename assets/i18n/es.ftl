...
# Filter dropdown
filter-dropdown-tooltip = Filtrar medios
filter-dropdown-tooltip-active = Activos: { $filters }
filter-panel-title = Filtro
filter-reset-button = Restablecer
filter-media-type-label = Tipo de medio
filter-media-type-all = Todos
filter-media-type-images = Solo imágenes
filter-media-type-videos = Solo vídeos
filter-media-type-placeholder = Seleccionar tipo...
filter-date-label = Filtro por fecha
filter-date-field-label = Filtrar por
filter-date-field-modified = Fecha de modificación
filter-date-field-created = Fecha de creación
filter-date-start-label = Desde
filter-date-end-label = Hasta
filter-date-day-placeholder = DD
filter-date-month-placeholder = MM
filter-date-year-placeholder = AAAA
filter-date-clear = Borrar fecha
filter-tooltip-date-from = desde { $date }
filter-tooltip-date-to = hasta { $date }
...
settings-max-skip-attempts-label = Omitir archivos corruptos
settings-max-skip-attempts-hint = Máximo de archivos corruptos consecutivos a omitir durante la navegación.
settings-persist-filters-label = Recordar filtros
settings-persist-filters-hint = Mantener la configuración de filtros entre sesiones.
settings-persist-filters-disabled = No
settings-persist-filters-enabled = Sí
...
video-no-audio-tooltip = Sin pista de audio
...
error-video-decoder-died = El decodificador de vídeo se detuvo inesperadamente. Intente recargar el vídeo.
error-video-seek-timeout = La búsqueda de posición expiró. La posición objetivo puede estar más allá del final del vídeo.
...
help-viewer-tool-filter = Filtrar
help-viewer-tool-filter-desc = Mostrar solo archivos coincidentes. Filtrar por tipo de medio, orientación o rango de fechas.
...
help-video-tool-volume-desc = Arrastre el control deslizante de volumen (0-150%) o haga clic en el icono del altavoz para silenciar/activar sonido.
...
help-editor-resize-ai-validation = El modelo IA se valida en el primer acceso al editor (no al iniciar)
...
help-metadata-role = Vea y edite los metadatos incrustados en sus archivos de imagen. Se admiten dos tipos: Dublin Core (XMP) para información descriptiva como título y autor, y EXIF para datos técnicos de la cámara.

help-metadata-tool-view = Modo visualización
help-metadata-tool-view-desc = Pulse I o haga clic en el botón Info para ver todos los metadatos en el panel lateral.
help-metadata-tool-edit = Modo edición
help-metadata-tool-edit-desc = Haga clic en Editar para modificar campos. Use « Añadir campo » para agregar metadatos. La validación se realiza mientras escribe.
...
help-metadata-field-dc = Dublin Core (XMP): título, autor, descripción, palabras clave, copyright
help-metadata-field-camera = Marca y modelo de cámara
help-metadata-field-date = Fecha de captura (con selector de fecha)
help-metadata-field-exposure = Tiempo de exposición, apertura, sensibilidad ISO
help-metadata-field-focal = Distancia focal y equivalente 35mm
help-metadata-field-gps = Coordenadas GPS (latitud y longitud)

help-metadata-formats = Formatos compatibles: JPEG, PNG, WebP y TIFF admiten Dublin Core y EXIF. Otros formatos pueden tener soporte limitado o de solo lectura.
help-metadata-note = Nota: Los archivos de vídeo muestran sus metadatos en modo de solo lectura. Solo los campos soportados por cada formato están disponibles para edición.
...
editor-metadata-write-failed = No se pudo agregar la etiqueta de software a este formato de imagen
...
notification-skipped-corrupted-files = Omitidos: { $files }
notification-skipped-and-others = +{ $count } más
...
settings-deblur-status-needs-validation = Modelo descargado (validación en el primer uso)
...
settings-upscale-status-needs-validation = Modelo descargado (validación en el primer uso)
...
help-editor-deblur-validation = El modelo se valida en el primer acceso al editor (no al iniciar)
