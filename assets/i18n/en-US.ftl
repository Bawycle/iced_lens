...
# Filter dropdown
filter-dropdown-tooltip = Filter media
filter-dropdown-tooltip-active = Active: { $filters }
filter-panel-title = Filter
filter-reset-button = Reset
filter-media-type-label = Media type
filter-media-type-all = All
filter-media-type-images = Images only
filter-media-type-videos = Videos only
filter-media-type-placeholder = Select type...
filter-date-label = Date filter
filter-date-field-label = Filter by
filter-date-field-modified = Modified date
filter-date-field-created = Created date
filter-date-start-label = From
filter-date-end-label = To
filter-date-day-placeholder = DD
filter-date-month-placeholder = MM
filter-date-year-placeholder = YYYY
filter-date-clear = Clear date
filter-tooltip-date-from = from { $date }
filter-tooltip-date-to = to { $date }
...
settings-persist-filters-label = Remember filters
settings-persist-filters-hint = Keep filter settings between sessions.
settings-persist-filters-disabled = Off
settings-persist-filters-enabled = On
...
error-video-decoder-died = The video decoder stopped unexpectedly. Try reloading the video.
error-video-seek-timeout = Seeking timed out. The target position may be beyond the end of the video.
...
help-viewer-tool-filter-desc = Show only matching files. Filter by media type, orientation, or date range.
